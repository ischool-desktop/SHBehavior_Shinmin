...
namespace K12.Behavior.WeekReport.Shinmin
{
    public partial class WeekDisciplineReportCount : SelectWeekForm
    {
        ...
        private void LoadPreference()
        {
            ...
            ConfigData cd = K12.Data.School.Configuration["獎懲週報表_列印設定_Shinmin"];
            ...
            {
                #region 產生空白設定檔
                config = new XmlDocument().CreateElement("獎懲週報表_列印設定_Shinmin");
        ...
        {
            WeekAbsenceReportConfig config = new WeekAbsenceReportConfig("獎懲週報表_列印設定_Shinmin", _sizeIndex, _classcix, _weekcix);
